        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Anggaran</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{route('dashboard')}}" class="nav-link {{ ($title==='Users')?'active':''}}">
                        ...
                        <li class="nav-item">
                            <a href="{{route('anggaran.index')}}" class="nav-link {{ ($title==='Anggaran')?'active':''}}">
                                <i class="nav-icon fas fa-users"></i>
                                <p>
                                    Anggaran
                                </p>
